...
export const WrapperOptions = ({ attributes, setAttributes }) => {
	...
	return (
		<Fragment>
			{!wrapperDisable &&
				<PanelBody title={__('Block Layout', 'Infinium')} initialOpen={false} className="custom-highlighted-panel">
					...
					{wrapperUseShowControl &&
						<ToggleControl
							label={wrapperUse ? __('Wrapper Enabled', 'Infinium') : __('Wrapper Disabled', 'Infinium')}
							checked={wrapperUse}
					...
					{(wrapperUse && wrapperUseSimpleShowControl) &&
						<ToggleControl
							label={wrapperUseSimple ? __('Wrapper Simple Enabled', 'Infinium') : __('Wrapper Simple Disabled', 'Infinium')}
